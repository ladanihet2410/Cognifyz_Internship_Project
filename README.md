...
│
├── 📁 Outputs/                                  ← All output charts/visualizations
```
...
### ✅ Task 1 — Top Cuisines
**Code:** [`Soucre_Code/Level1_Task1_TopCuisines.py`](./Soucre_Code/Level1_Task1_TopCuisines.py) &nbsp;|&nbsp; **Output:** [`Level1_Task1_TopCuisines.png`](./Outputs/Level1_Task1_TopCuisines.png)
...
**Code:** [`Soucre_Code/Level1_Task2_CityAnalysis.py`](./Soucre_Code/Level1_Task2_CityAnalysis.py) &nbsp;|&nbsp; **Output:** [`Level1_Task2_CityAnalysis.png`](./Outputs/Level1_Task2_CityAnalysis.png)
...
**Code:** [`Soucre_Code/Level1_Task3_PriceRangeDistribution.py`](./Soucre_Code/Level1_Task3_PriceRangeDistribution.py) &nbsp;|&nbsp; **Output:** [`Level1_Task3_PriceRangeDistribution.png`](./Outputs/Level1_Task3_PriceRangeDistribution.png)
...
**Code:** [`Soucre_Code/Level1_Task4_OnlineDelivery.py`](./Soucre_Code/Level1_Task4_OnlineDelivery.py) &nbsp;|&nbsp; **Output:** [`Level1_Task4_OnlineDelivery.png`](./Outputs/Level1_Task4_OnlineDelivery.png)
...
**Code:** [`Soucre_Code/Level2_Task1_RestaurantRatings.py`](./Soucre_Code/Level2_Task1_RestaurantRatings.py) &nbsp;|&nbsp; **Output:** [`Level2_Task1_RestaurantRatings.png`](./Outputs/Level2_Task1_RestaurantRatings.png)
...
**Code:** [`Soucre_Code/Level2_Task2_CuisineCombination.py`](./Soucre_Code/Level2_Task2_CuisineCombination.py) &nbsp;|&nbsp; **Output:** [`Level2_Task2_CuisineCombination.png`](./Outputs/Level2_Task2_CuisineCombination.png)
...
**Code:** [`Soucre_Code/Level2_Task3_GeographicAnalysis.py`](./Soucre_Code/Level2_Task3_GeographicAnalysis.py) &nbsp;|&nbsp; **Output:** [`Level2_Task3_GeographicAnalysis.png`](./Outputs/Level2_Task3_GeographicAnalysis.png)
...
**Code:** [`Soucre_Code/Level2_Task4_RestaurantChains.py`](./Soucre_Code/Level2_Task4_RestaurantChains.py) &nbsp;|&nbsp; **Output:** [`Level2_Task4_RestaurantChains.png`](./Outputs/Level2_Task4_RestaurantChains.png)
...
|------|-----------|---------------|
| L1 – Top Cuisines | [`Level1_Task1_TopCuisines.png`](./Outputs/Level1_Task1_TopCuisines.png) | Bar chart of top 3 cuisines & their share |
| L1 – City Analysis | [`Level1_Task2_CityAnalysis.png`](./Outputs/Level1_Task2_CityAnalysis.png) | Avg ratings per city, ranked |
| L1 – Price Range | [`Level1_Task3_PriceRangeDistribution.png`](./Outputs/Level1_Task3_PriceRangeDistribution.png) | Distribution across price categories |
| L1 – Online Delivery | [`Level1_Task4_OnlineDelivery.png`](./Outputs/Level1_Task4_OnlineDelivery.png) | Rating comparison: delivery vs no delivery |
| L2 – Rating Distribution | [`Level2_Task1_RestaurantRatings.png`](./Outputs/Level2_Task1_RestaurantRatings.png) | Histogram of aggregate ratings |
| L2 – Cuisine Combos | [`Level2_Task2_CuisineCombination.png`](./Outputs/Level2_Task2_CuisineCombination.png) | Top cuisine pairings & avg ratings |
| L2 – Geographic Map | [`Level2_Task3_GeographicAnalysis.png`](./Outputs/Level2_Task3_GeographicAnalysis.png) | Scatter map of restaurant locations |
| L2 – Restaurant Chains | [`Level2_Task4_RestaurantChains.png`](./Outputs/Level2_Task4_RestaurantChains.png) | Chain popularity by votes & rating |
