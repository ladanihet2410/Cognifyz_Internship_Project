...
│
├── 📁 Soucre_Code/                              ← All Python scripts (one per task)
...
│
├── Level1_Task1_TopCuisines.png                 ← Output charts/visualizations
...
> 💡 **Quick navigation:**
> - Want to read the code? → [`Soucre_Code/`](./Soucre_Code)
> - Want to see the charts? → scroll down to [Output Previews](#-output-previews) or browse the `.png` files above
...
### ✅ Task 1 — Top Cuisines
**Code:** [`Soucre_Code/Level1_Task1_TopCuisines.py`](./Soucre_Code/Level1_Task1_TopCuisines.py) &nbsp;|&nbsp; **Output:** [`Level1_Task1_TopCuisines.png`](./Level1_Task1_TopCuisines.png)
...
**Code:** [`Soucre_Code/Level1_Task2_CityAnalysis.py`](./Soucre_Code/Level1_Task2_CityAnalysis.py) &nbsp;|&nbsp; **Output:** [`Level1_Task2_CityAnalysis.png`](./Level1_Task2_CityAnalysis.png)
...
**Code:** [`Soucre_Code/Level1_Task3_PriceRangeDistribution.py`](./Soucre_Code/Level1_Task3_PriceRangeDistribution.py) &nbsp;|&nbsp; **Output:** [`Level1_Task3_PriceRangeDistribution.png`](./Level1_Task3_PriceRangeDistribution.png)
...
**Code:** [`Soucre_Code/Level1_Task4_OnlineDelivery.py`](./Soucre_Code/Level1_Task4_OnlineDelivery.py) &nbsp;|&nbsp; **Output:** [`Level1_Task4_OnlineDelivery.png`](./Level1_Task4_OnlineDelivery.png)
...
**Code:** [`Soucre_Code/Level2_Task1_RestaurantRatings.py`](./Soucre_Code/Level2_Task1_RestaurantRatings.py) &nbsp;|&nbsp; **Output:** [`Level2_Task1_RestaurantRatings.png`](./Level2_Task1_RestaurantRatings.png)
...
**Code:** [`Soucre_Code/Level2_Task2_CuisineCombination.py`](./Soucre_Code/Level2_Task2_CuisineCombination.py) &nbsp;|&nbsp; **Output:** [`Level2_Task2_CuisineCombination.png`](./Level2_Task2_CuisineCombination.png)
...
**Code:** [`Soucre_Code/Level2_Task3_GeographicAnalysis.py`](./Soucre_Code/Level2_Task3_GeographicAnalysis.py) &nbsp;|&nbsp; **Output:** [`Level2_Task3_GeographicAnalysis.png`](./Level2_Task3_GeographicAnalysis.png)
...
**Code:** [`Soucre_Code/Level2_Task4_RestaurantChains.py`](./Soucre_Code/Level2_Task4_RestaurantChains.py) &nbsp;|&nbsp; **Output:** [`Level2_Task4_RestaurantChains.png`](./Level2_Task4_RestaurantChains.png)
...
3. **Update the dataset path** inside any script in `Soucre_Code/`
   ```python
...
4. **Run any script**
   ```bash
   python Soucre_Code/Level1_Task1_TopCuisines.py
   ```
...
All chart outputs are stored as `.png` files in the root of the repository. Here's a summary of what each one shows:

| Task | Chart File | What it shows |
|------|-----------|---------------|
| L1 – Top Cuisines | [`Level1_Task1_TopCuisines.png`](./Level1_Task1_TopCuisines.png) | Bar chart of top 3 cuisines & their share |
| L1 – City Analysis | [`Level1_Task2_CityAnalysis.png`](./Level1_Task2_CityAnalysis.png) | Avg ratings per city, ranked |
| L1 – Price Range | [`Level1_Task3_PriceRangeDistribution.png`](./Level1_Task3_PriceRangeDistribution.png) | Distribution across price categories |
| L1 – Online Delivery | [`Level1_Task4_OnlineDelivery.png`](./Level1_Task4_OnlineDelivery.png) | Rating comparison: delivery vs no delivery |
| L2 – Rating Distribution | [`Level2_Task1_RestaurantRatings.png`](./Level2_Task1_RestaurantRatings.png) | Histogram of aggregate ratings |
| L2 – Cuisine Combos | [`Level2_Task2_CuisineCombination.png`](./Level2_Task2_CuisineCombination.png) | Top cuisine pairings & avg ratings |
| L2 – Geographic Map | [`Level2_Task3_GeographicAnalysis.png`](./Level2_Task3_GeographicAnalysis.png) | Scatter map of restaurant locations |
| L2 – Restaurant Chains | [`Level2_Task4_RestaurantChains.png`](./Level2_Task4_RestaurantChains.png) | Chain popularity by votes & rating |
